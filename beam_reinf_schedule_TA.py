...
move_1, move_2, move_3, move_4 = (
    v6_flexural_df["Residual Rebar (mm2)"],
    v6_flexural_df["Top Rebar Area Provided (mm2)"],
    v6_flexural_df["Bottom Rebar Area Provided (mm2)"],
    v6_flexural_df["Side Face Clear Space (mm)"],
)
...
# Create TA_v6_flexural_df, whereby only beam ID, Bottom Rebar Provided, Bottom Rebar Schedule, and same for top is present
# TA_v6_flexural_df = pd.concat(v6_flexural_df["ETABS beam ID"], v6_flexural_df[""Bottom Rebar Area Provided (mm2)"
...
#         # replace the last and first values in the group with the values from the max row
#         group.at[group.index[0], "Shear area provided (mm2)"] = max_row[
#             "Shear area provided (mm2)"
#         ]
#         group.at[group.index[0], "Shear Link Schedule"] = max_row["Shear Link Schedule"]
#         group.at[group.index[-1], "Shear area provided (mm2)"] = max_row[
#             "Shear area provided (mm2)"
#         ]
#         group.at[group.index[-1], "Shear Link Schedule"] = max_row[
#             "Shear Link Schedule"
#         ]
