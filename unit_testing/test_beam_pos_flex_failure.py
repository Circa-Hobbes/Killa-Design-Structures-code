...
def test_bot_flex_rebar_string(example_beam: Beam):
    ...
    assert example_beam.flex_bot_left_rebar_string == "Overstressed. Please re-assess"
    assert example_beam.flex_bot_middle_rebar_string == "Overstressed. Please re-assess"
    assert example_beam.flex_bot_right_rebar_string == "Overstressed. Please re-assess"
...
def test_bot_flex_rebar_area(example_beam: Beam):
    ...
    assert example_beam.flex_bot_left_rebar_area == "Overstressed. Please re-assess"  # type: ignore
    assert example_beam.flex_bot_middle_rebar_area == "Overstressed. Please re-assess"  # type: ignore
    assert example_beam.flex_bot_right_rebar_area == "Overstressed. Please re-assess"  # type: ignore
