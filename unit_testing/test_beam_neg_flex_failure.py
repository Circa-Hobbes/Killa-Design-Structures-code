...
def test_top_flex_rebar_string(example_beam: Beam):
    ...
    assert example_beam.flex_top_left_rebar_string == "Overstressed. Please re-assess"
    assert example_beam.flex_top_middle_rebar_string == "Overstressed. Please re-assess"
    assert example_beam.flex_top_right_rebar_string == "Overstressed. Please re-assess"
...
def test_top_flex_rebar_area(example_beam: Beam):
    ...
    assert example_beam.flex_top_left_rebar_area == "Overstressed. Please re-assess"  # type: ignore
    assert example_beam.flex_top_middle_rebar_area == "Overstressed. Please re-assess"  # type: ignore
    assert example_beam.flex_top_right_rebar_area == "Overstressed. Please re-assess"  # type: ignore
...
def test_residual_rebar(example_beam: Beam):
    ...
    assert example_beam.left_residual_rebar is None
    assert example_beam.middle_residual_rebar is None
    assert example_beam.right_residual_rebar is None
...
def test_side_face_string(example_beam: Beam):
    ...
    assert example_beam.side_face_left_string == "Overstressed. Please reassess"
    assert example_beam.side_face_middle_string == "Overstressed. Please reassess"
    assert example_beam.side_face_right_string == "Overstressed. Please reassess"
...
def test_side_face_area(example_beam: Beam):
    ...
    assert example_beam.side_face_left_area == "Overstressed. Please reassess"
    assert example_beam.side_face_middle_area == "Overstressed. Please reassess"
    assert example_beam.side_face_right_area == "Overstressed. Please reassess"
...
def test_index_for_side_face_reinf(example_beam: Beam):
    ...
    assert (
        example_beam.selected_side_face_reinforcement_string
...
def test_min_shear_long_spacing(example_beam: Beam):
    ...
    assert example_beam.min_shear_long_spacing == 0
    assert example_beam.min_shear_centre_long_spacing == 0
